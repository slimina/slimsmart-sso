...
<jsp:directive.include file="includes/top.jsp" />
			<form:form method="post" id="fm1" cssClass="fm-v clearfix" commandName="${commandName}" htmlEscape="true">
			   	   <c:if test="${empty authcodeError}">
			   	   		<form:errors path="*" cssClass="errors" id="status" element="div" /> 
                    </c:if>
                    <c:if test="${not empty authcodeError}">
                   	 <div class="errors" id="status" style="background-color: rgb(255, 238, 221);"><spring:message code="${authcodeError}" /></div>
                    </c:if>
                <div class="box" id="login">
                <!-- <spring:message code="screen.welcome.welcome" /> -->
                    <div style="font-size: 14px;"><spring:message code="screen.welcome.instructions" /></div>
                    <div class="row">
                    ...
                    <div class="row">
						...
						<form:input cssClass="required" cssErrorClass="error" id="authcode" size="8" tabindex="2" path="authcode"  accesskey="${authcodeAccessKey}" htmlEscape="true" autocomplete="off" />
						</td>
