                    ...
                    <div class="row fl-controls-left">
						...
						<tr>
								<td>
									...
									<form:password cssClass="required" cssErrorClass="error" id="authcode" size="10" tabindex="2" path="authcode"  accesskey="${authcodeAccessKey}" htmlEscape="true" autocomplete="off" />
								</td>
								<td align="left" valign="bottom" style="vertical-align: middle;">
									&nbsp; <img title='<spring:message  code="screen.welcome.label.authcode.tip" />'  class="required" tabindex="2" width="93" height="30" onclick="this.src='captcha.jpg?'+Math.random()" src="captcha.jpg" />						
